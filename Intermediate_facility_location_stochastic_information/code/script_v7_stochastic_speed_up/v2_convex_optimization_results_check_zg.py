...
#         problems=['Stochastic','Wait_and_see','Deterministic','VSS','VSS_investors','Investors','CDA']
        ...
        for problem in problems:
            ...
            if problem == 'Stochastic':
                print('===== The stochastic centralized problem has started =====')
                start = time.time()
...
#                 print(obj_vss_investors)
                ...
                start = time.time()
                rho_check = {(1,2): 308.805300, (1,5): 321.874325}
#                 rho_check = {(1,3):221.282093, (1,6): 147.163413, (1,12): 236.304753, (1,17): 218.876795, (1,22): 339.812502,
#                             (2,3): 1390.966307, (2,6): 1240.224452, (2,12): 1400.391371, (2,17): 1390.834712, (2,22): 1547.016581}
                g_investors, c_investors, obj_investors =  Ntw.investors_check(rho_check)
#                 print(obj_vss_investors)
                ...
                start = time.time()
                q_cda, x_cda, v_cda, lamda1_cda, lamda2_cda, mu_cda =  Ntw.CDA_model_check(rho_check)
#                 print(obj_vss_investors)
